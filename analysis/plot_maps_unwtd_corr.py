...
def plot_ensemble_all_models(
    ...
    panels = [
        ...
        ('cnn_pt', 'weighted_correlation', 0, axs[0,2], r'(d) $u_{i,t}$'),
        ('cnn_pt', 'weighted_correlation', 1, axs[0,3], r'(d) $v_{i,t}$'),
        ('lr_cf', 'correlation', 0, axs[1,0], r'(b) $u_{i,t}$'),
        ('lr_cf', 'correlation', 1, axs[1,1], r'(b) $v_{i,t}$'),
        ('lr_cf', 'weighted_correlation', 0, axs[1,2], r'(e) $u_{i,t}$'),
        ('lr_cf', 'weighted_correlation', 1, axs[1,3], r'(e) $v_{i,t}$'),
        ('ps', 'correlation', 0, axs[2,0], r'(c) $u_{i,t}$'),
        ('ps', 'correlation', 1, axs[2,1], r'(c) $v_{i,t}$'),
        ('ps', 'weighted_correlation', 0, axs[2,2], r'(f) $u_{i,t}$'),
        ('ps', 'weighted_correlation', 1, axs[2,3], r'(f) $v_{i,t}$'),
    ]
