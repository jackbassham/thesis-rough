...
PLOT_PATH = Path('/home/jbassham/jack/thesis-rough/analysis/slide_plots/')
...
def plot_ensemble_all_models(
    ...
    panels = [
        ...
        ('ps', 'weighted_correlation', 0, axs[2,0], r'(c) PS $(u_{i,t})$'),
        ('ps', 'weighted_correlation', 1, axs[2,1], r'(c) PS $(v_{i,t})$'),
    ]
