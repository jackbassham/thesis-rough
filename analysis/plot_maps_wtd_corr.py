...
PLOT_PATH = Path('/home/jbassham/jack/thesis-rough/analysis3/final_plots/maps_wtd_metrics_wtd')
...
def plot_ensemble_all_models(
    ...
    #~~~~~~~~~~~~~~~~~~~~~
    panels = [
        ('cnn_pt_wtd', 'weighted_correlation', 0, axs[0,0], r'WCNN, $u_{i,t}$'),
        ('cnn_pt_wtd', 'weighted_correlation', 1, axs[0,1], r'WCNN, $v_{i,t}$'),
        ('lr_cf_wtd', 'weighted_correlation', 0, axs[1,0], r'WLR, $u_{i,t}$'),
        ('lr_cf_wtd', 'weighted_correlation', 1, axs[1,1], r'WLR, $v_{i,t}$'),
        ('ps', 'weighted_correlation', 0, axs[2,0], r'PS, $u_{i,t}$'),
        ('ps', 'weighted_correlation', 1, axs[2,1], r'PS, $v_{i,t}$'),
    ]
