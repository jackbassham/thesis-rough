...
PATH_DEST = "/home/jbassham/jack/data/sh/inputs_v5"
...
def main():
    ...
    # 5. ** Uncertainty here is scaled by 10
    ...
    rt_filtered = np.where(rt_masked > 1000, rt_masked - 1000, rt_masked)

    # rtn = rt_filtered / 10.0

    # Normalize uncertainty by standard deviation of speed
    rtn = rt_filtered / cit_std
