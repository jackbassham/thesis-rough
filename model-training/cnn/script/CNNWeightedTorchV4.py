...
# 2. Changed paths to use inputs without mean removed
# 2. Did not remove uncertainty clamping; was necessary to prevent nan loss
# 3. Normalized uncertainty by cit_std (~7 cm/s)
######################################################################

START_YEAR = 1992
END_YEAR = 2020
HEM = 'sh'
VERSION = 'weightedtorchV4'

PATH_SOURCE = "/home/jbassham/jack/data/sh/inputs_v4/cnn_inputs"
PATH_DEST = "/home/jbassham/jack/data/sh/outputs_v4"
