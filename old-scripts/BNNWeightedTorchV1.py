...
######################################################################
# NOTE Bayesian Neural Network modified from CNNWeightedTorchV5.py
######################################################################
# NOTES
# 1. tanh activation function for 0 mean center? https://mpj1001.user.srcf.net/papers/Neurips_US_MPJ_all.pdf
...
# NOTE Using V5 Inputs
PATH_SOURCE = "/home/jbassham/jack/data/sh/inputs_v5/cnn_inputs"

# NOTE 'v6' Outputs
PATH_DEST = "/home/jbassham/jack/data/sh/outputs_v6"
